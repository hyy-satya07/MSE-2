    ...
    <aside className="filters">
      ...
      <div className="filter-group">
        ...
        <select className="sort-select" value={sortBy} onChange={e => onSortChange(e.target.value)}>
          ...
          <option value="price-asc">Price: Low to High</option> // Here value was "price-desc" instead of "price-asc", which was wrong as this sorting was for Price: Low to High.
          <option value="price-desc">Price: High to Low</option> // Here value was "price-asc" instead of "price-desc", which was wrong as this sorting was for Price: High to Low.
